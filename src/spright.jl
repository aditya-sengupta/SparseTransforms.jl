...
"""
Struct to store encoder/decoder configurations and carry out encoding/decoding.
...
struct SPRIGHT
    ...
    """
    function transform(signal::InputSignal, verbose::Bool=false, report::Bool=False)
